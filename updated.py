...
BOT_REDIRECT_LINK = "https://t.me/ScammerFuk"
...
class PasswordReset:
    ...
    def send_password_reset(self):
        try:
            ...
            session.get("https://www.instagram.com/accounts/password/reset/", timeout=5)
...
def help_command(message):
    if not check_membership(message.from_user.id):
        ...
        keyboard.row(InlineKeyboardButton("📢 Main Channel", url=CHANNEL_LINK))
        keyboard.row(InlineKeyboardButton("🤖 Bot Redirect", url=BOT_REDIRECT_LINK))
        bot.reply_to(message, "❌ Please join our channels first to use this bot!", reply_markup=keyboard)
        return
...
def process_reset_step(message):
    ...
    processing_msg = bot.reply_to(message, "🔄 Processing your request... [░░░░░░░░░░░░░░░░░░░░] 0%")
...
def process_bulk_step(message):
    ...
    processing_msg = bot.reply_to(message, f"🔄 Processing {len(targets)} accounts... [░░░░░░░░░░░░░░░░░░░░] 0%")
